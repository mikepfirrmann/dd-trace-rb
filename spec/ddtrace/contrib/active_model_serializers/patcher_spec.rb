...
RSpec.describe 'ActiveModelSerializers patcher' do
  ...
  after(:each) { Datadog.registry[:active_model_serializers].reset_configuration! }
    ...
    if ActiveModelSerializersHelpers.ams_0_10_or_newer?
      context 'when adapter is set' do
        ...
        it_behaves_like 'analytics for integration' do
          let(:analytics_enabled_var) { Datadog::Contrib::ActiveModelSerializers::Ext::ENV_ANALYTICS_ENALBED }
